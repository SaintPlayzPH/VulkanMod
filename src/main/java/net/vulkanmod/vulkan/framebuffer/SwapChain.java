...
public class SwapChain extends Framebuffer {
    ...
    private void createSwapChain() {
        try (MemoryStack stack = stackPush()) {
            ...
            int requestedImages = Initializer.CONFIG.presentMode == 1 && Initializer.CONFIG.forceFIFOVsync ? surfaceProperties.capabilities.minImageCount() : Math.max(Initializer.CONFIG.imageCount, surfaceProperties.capabilities.minImageCount());
